...
function calculateSolar(){    
    ...
    var feedback = "";
    feedback += '<p> Based on your average dail use of '+ Math.round(dailyUseKw) +' Kwh, you will need to purchase' + panelsNeeded + " " + panelName + '  </p>'
    feedback += '<h2> Additional Detail </h2>'
    feedback += "<p> Your average daily electricity consumption: " + Math.round(dailyUseKw) +" Kwh per day. <p> "
    feedback += "<p> Average sunchshine hours per day: "+ sunHoursPerDay +" hours </p> "
    feedback += "<p> Realistic watts needed per hours: " + Math.round(realWattNeeds) +" watts/hours. </p>"
